...
const BlogTitle = () => {
  ...
  const blogCategories=['General','Technology','Travel','Education','Food','Lifestyle','Health','Business']
    ...
    const onSubmitHandler=async(e)=>{
      ...
      try {
        setLoading(true)
        const prompt=`Generate a blog for the keyword ${input} in the category ${selectedCategory}`
    ...
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
            <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200' >
               <div className='flex items-center gap-3'>
                 <Sparkles className='w-6 text-[#8E34EB]'/>
